# SUBMIT_day2.md — AIOps Day 2: Log Parsing với Drain3
...
| File | Mô tả |
|------|-------|
| `day2/assignment_day2.ipynb` | Notebook đầy đủ: Drain3 simulation, tuning, time series, anomaly detection |
| `day2/SUBMIT_day2.md` | File này |
| `day2/images/plot_template_timeseries.png` | Plot chính: template count time series + anomaly highlighted |
| `day2/images/plot_top10_templates.png` | Top-10 templates theo tần suất |
| `day2/images/plot_tuning_simth.png` | Tuning log: sim_th sweep |
| `day2/images/plot_metric_vs_log.png` | Metric vs Log correlation |
| `day2/images/drain_output.json` | Raw Drain3 output (JSON) |
| `day2/images/knowledge_check_day2_p*.jpg` | ✏️ **Ảnh viết tay — sẽ upload sau** |
...
- [x] `assignment_day2.ipynb` — hoàn chỉnh, chạy được
- [x] `SUBMIT_day2.md` — file này
