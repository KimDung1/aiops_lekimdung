...
plt.tight_layout()
out1 = 'images/plot_template_timeseries.png'
...
ax.set_facecolor('#F8F9FA')
plt.tight_layout()
out2 = 'images/plot_top10_templates.png'
...
ax.set_facecolor('#F8F9FA')
plt.tight_layout()
out3 = 'images/plot_tuning_simth.png'
...
with open('images/drain_output.json', 'w') as f:
    json.dump(drain_output, f, indent=2)
print(f"   ✅ Saved: images/drain_output.json")
